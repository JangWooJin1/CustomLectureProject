...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='LectureGroup',
            fields=[
                ('lecture_code', models.CharField(max_length=8, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appsearch.lecturegroup')),
            ],
        ),
        migrations.CreateModel(
            name='UserBasket',
